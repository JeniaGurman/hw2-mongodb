...
import { FIFTEEN_MINUTES, ONE_DAY, TEMPLATES_DIR } from "../constants/constans.js";
...
const createSession = () => {
    ...
    return {
        accessToken, refreshToken, accessTokenValidUntil: new Date(Date.now() + FIFTEEN_MINUTES),
        refreshTokenValidUntil: new Date(Date.now() + ONE_DAY),
    };
};
